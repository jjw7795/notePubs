window.addEventListener("load", function(){
	...
	var textArea = editor.querySelector(".text-area");
	var boldButton = editor.querySelector(".btn-bold");
	var italicButton = editor.querySelector(".btn-italic");
	var imgButton = editor.querySelector(".btn-image");
	var fileButton = editor.querySelector(".file-button");
	...
	fileButton.oninput = function(e){
		...
		xhr.onload = function(){
			...
			document.execCommand("insertHTML" ,
					false, 
					`<img style="width:200px;" src="/resource/images/2020/newlec/${file.name}" >`);
