...
importCSS("../../resources/js/lib/web-editor/multi-editor.css");
...
window.addEventListener("load", function() {
	...
	for(var i=0; i<textAreas.length; i++){
		...
		(function(){
		    ...
		    request.onload = function (e) {
		        ...
		        var fileUpload = function(file){
	    			...
	    			xhr.onload = function(e) {
	                    ...
	                    var path = ctxName+xhr.responseText; // uploaded file path and name,
	                    console.log(path);
		    ...
		    request.open("GET", "../../resources/js/lib/web-editor/single-editor.html");
		    request.send(null);
		})();	
	}
